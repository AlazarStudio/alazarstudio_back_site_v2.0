...
const PRISMA_MODEL_KEY = "teamStructure"
const STRUCTURE_COLLECTION = "team_structures"
...
// @desc    Get structure
// @route   GET /api/teamStructure
// @access  Private
export const getTeamStructure = asyncHandler(async (req, res) => {
...
// @route   PUT /api/teamStructure
// @access  Private
export const updateTeamStructure = asyncHandler(async (req, res) => {
