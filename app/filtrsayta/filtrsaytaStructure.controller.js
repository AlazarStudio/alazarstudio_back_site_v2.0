...
const PRISMA_MODEL_KEY = "filtrsaytaStructure"
const STRUCTURE_COLLECTION = "filtrsayta_structures"
const RESOURCE_NAME = "filtrsayta"
...
// @desc    Get structure
// @route   GET /api/filtrsaytaStructure
// @access  Private
export const getFiltrsaytaStructure = asyncHandler(async (req, res) => {
...
// @route   PUT /api/filtrsaytaStructure
// @access  Private
export const updateFiltrsaytaStructure = asyncHandler(async (req, res) => {
