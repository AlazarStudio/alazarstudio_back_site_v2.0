...
const PRISMA_MODEL_KEY = "servicesStructure"
const STRUCTURE_COLLECTION = "services_structures"
...
// @desc    Get structure
// @route   GET /api/servicesStructure
// @access  Private
export const getServicesStructure = asyncHandler(async (req, res) => {
...
// @route   PUT /api/servicesStructure
// @access  Private
export const updateServicesStructure = asyncHandler(async (req, res) => {
