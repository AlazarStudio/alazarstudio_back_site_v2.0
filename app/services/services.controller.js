...
const MODEL_KEY = "services"
const COLLECTION_NAME = "servicess"
...
// @access  Private
export const getServicess = asyncHandler(async (req, res) => {
...
// @desc    Get published services (public)
// @route   GET /api/services/public
// @access  Public
export const getPublicServicess = asyncHandler(async (req, res) => {
