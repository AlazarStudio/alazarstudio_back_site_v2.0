...
const PRISMA_MODEL_KEY = "casesStructure"
const STRUCTURE_COLLECTION = "cases_structures"
const RESOURCE_NAME = "cases"
...
// @desc    Get structure
// @route   GET /api/casesStructure
// @access  Private
export const getCasesStructure = asyncHandler(async (req, res) => {
...
// @route   PUT /api/casesStructure
// @access  Private
export const updateCasesStructure = asyncHandler(async (req, res) => {
