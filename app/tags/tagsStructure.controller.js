...
const PRISMA_MODEL_KEY = "tagsStructure"
const STRUCTURE_COLLECTION = "tags_structures"
...
// @desc    Get structure
// @route   GET /api/tagsStructure
// @access  Private
export const getTagsStructure = asyncHandler(async (req, res) => {
...
// @route   PUT /api/tagsStructure
// @access  Private
export const updateTagsStructure = asyncHandler(async (req, res) => {
