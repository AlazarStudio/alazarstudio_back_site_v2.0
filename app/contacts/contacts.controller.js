...
const MODEL_KEY = "contacts"
const COLLECTION_NAME = "contactss"
...
// @access  Private
export const getContactss = asyncHandler(async (req, res) => {
...
// @desc    Get published contacts (public)
// @route   GET /api/contacts/public
// @access  Public
export const getPublicContactss = asyncHandler(async (req, res) => {
...
// @access  Private
export const getContactsById = asyncHandler(async (req, res) => {
  const model = getModel()
  const item = model
