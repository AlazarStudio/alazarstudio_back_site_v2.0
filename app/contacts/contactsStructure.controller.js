...
const PRISMA_MODEL_KEY = "contactsStructure"
const STRUCTURE_COLLECTION = "contacts_structures"
...
// @desc    Get structure
// @route   GET /api/contactsStructure
// @access  Private
export const getContactsStructure = asyncHandler(async (req, res) => {
...
// @route   PUT /api/contactsStructure
// @access  Private
export const updateContactsStructure = asyncHandler(async (req, res) => {
