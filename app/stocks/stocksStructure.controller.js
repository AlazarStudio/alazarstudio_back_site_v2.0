...
const PRISMA_MODEL_KEY = "stocksStructure"
const STRUCTURE_COLLECTION = "stocks_structures"
...
// @desc    Get structure
// @route   GET /api/stocksStructure
// @access  Private
export const getStocksStructure = asyncHandler(async (req, res) => {
...
// @route   PUT /api/stocksStructure
// @access  Private
export const updateStocksStructure = asyncHandler(async (req, res) => {
