...
const MODEL_KEY = "stocks"
const COLLECTION_NAME = "stockss"
...
// @access  Private
export const getStockss = asyncHandler(async (req, res) => {
...
// @desc    Get published stocks (public)
// @route   GET /api/stocks/public
// @access  Public
export const getPublicStockss = asyncHandler(async (req, res) => {
...
// @desc    Get single stocks
// @route   GET /api/stocks/:id
// @access  Private
export const getStocksById = asyncHandler(async (req, res) => {
  const model = getModel()
  const item = model
...
// @access  Private
export const createStocks = asyncHandler(async (req, res) => {
  const model = getModel()
  const item = model
...
// @access  Private
export const updateStocks = asyncHandler(async (req, res) => {
  const model = getModel()
