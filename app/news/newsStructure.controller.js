...
const PRISMA_MODEL_KEY = "newsStructure"
const STRUCTURE_COLLECTION = "news_structures"
...
// @desc    Get structure
// @route   GET /api/newsStructure
// @access  Private
export const getNewsStructure = asyncHandler(async (req, res) => {
...
// @route   PUT /api/newsStructure
// @access  Private
export const updateNewsStructure = asyncHandler(async (req, res) => {
